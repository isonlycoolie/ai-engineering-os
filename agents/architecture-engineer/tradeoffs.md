...
- [`architecture-rules.md`](architecture-rules.md) - ADR process and structural rules
- [`anti-patterns.md`](anti-patterns.md) - patterns that violate these tradeoffs
- [`standards/api.md`](../../standards/api.md) - API versioning and envelope tradeoffs already decided globally
