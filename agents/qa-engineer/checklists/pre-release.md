...
Complete every item before attaching the QA report and recommending release. Attach evidence (CI run link, coverage artifact, test names) for each checked item.
...
- [ ] QA report is written using [`templates/qa-report.md`](../templates/qa-report.md)
- [ ] QA report is attached to the pull request

---

## Documentation

- [ ] Known edge cases and expected behavior are documented in the QA report
...
|------|------|------|----------|
| QA Engineer (agent) | | | Pass / Fail recommendation |
| QA Engineer (human) | | | Release approved / Changes required |
