...
**Prometheus / monitor query:** `[query or link]`
...
|----------|--------|-----------------|
| [Bad deploy] | Roll back to previous version - see Rollback below | Error rate returns to baseline |
