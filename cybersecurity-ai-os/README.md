...
Threat modeling, auth review, dependency risk.

Portable **enterprise engineering intelligence** for AI-assisted work. Copy this folder anywhere in your project.

## Quick start

1. Copy `cybersecurity-ai-os/` into your repo (any path you choose).
2. Tell AI: `Use ./cybersecurity-ai-os while working on [task].`
