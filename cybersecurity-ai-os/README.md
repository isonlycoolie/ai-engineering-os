...
Threat modeling, auth review, dependency risk, and secure implementation guidance.
...
1. Copy the `cybersecurity-ai-os/` folder into your project (any location you prefer).
2. Tell your AI assistant to use it, for example:

   ```
   Use ./cybersecurity-ai-os while implementing [your task].
   ```
...
my-project/
├── src/
├── cybersecurity-ai-os/          # at repo root
```

```
my-project/
├── docs/ai/cybersecurity-ai-os/  # under docs
```

```
my-project/
├── tools/cybersecurity-ai-os/    # under tools
```
