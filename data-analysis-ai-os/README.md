# Data Analysis AI Engineering

Reproducible analysis and decision-grade reporting.

Portable **enterprise engineering intelligence** for AI-assisted work. Copy this folder anywhere in your project.

## Quick start

1. Copy `data-analysis-ai-os/` into your repo (any path you choose).
2. Tell AI: `Use ./data-analysis-ai-os while working on [task].`
