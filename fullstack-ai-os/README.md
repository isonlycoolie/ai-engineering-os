...
End-to-end features with contract-first coordination.

Portable **enterprise engineering intelligence** for AI-assisted work. Copy this folder anywhere in your project.

## Quick start

1. Copy `fullstack-ai-os/` into your repo (any path you choose).
2. Tell AI: `Use ./fullstack-ai-os while working on [task].`
