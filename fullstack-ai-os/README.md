...
End-to-end feature delivery across UI and API with coordinated contracts and reviews.
...
1. Copy the `fullstack-ai-os/` folder into your project (any location you prefer).
2. Tell your AI assistant to use it, for example:

   ```
   Use ./fullstack-ai-os while implementing [your task].
   ```
...
my-project/
├── src/
├── fullstack-ai-os/          # at repo root
```

```
my-project/
├── docs/ai/fullstack-ai-os/  # under docs
```

```
my-project/
├── tools/fullstack-ai-os/    # under tools
```
