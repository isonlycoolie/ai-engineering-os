...
Training, eval, deployment guardrails, monitoring.

Portable **enterprise engineering intelligence** for AI-assisted work. Copy this folder anywhere in your project.

## Quick start

1. Copy `machine-learning-ai-os/` into your repo (any path you choose).
2. Tell AI: `Use ./machine-learning-ai-os while working on [task].`
